      ...
      var u = {
          ...
          methods: {
            getNewSong: function() {
              var t = this;
              axios
                .get("http://46.101.60.239:3001/personalized/newsong?limit=5")
                .then(
                  function(s) {
            ...
            getNewCd: function() {
              var t = this;
              axios
                .get("http://46.101.60.239:3001/top/album?offset=0&limit=5")
                .then(
                  function(s) {
      ...
      var m = {
          ...
          methods: {
            ...
            getListSongs1: function(t) {
              var s = this;
              axios.get("http://46.101.60.239:3001/playlist/detail?id=" + t).then(
                function(t) {
      ...
      var f = {
          ...
          methods: {
            getHotTopic: function() {
              var t = this;
              axios.get("http://46.101.60.239:3001/hot/topic?limit=9").then(
                function(s) {
      ...
      var g = {
          ...
          methods: {
            ...
            logOut: function() {
              axios
                .post(
                  "http://46.101.60.239:3001/logout?cookie=" + this.sessionCookie
                )
                .then(
                  function(t) {
                    console.log(t);
        ...
        I = {
          ...
          methods: {
            ...
            getUserDetail: function() {
              ...
              axios
                .get(
                  "http://46.101.60.239:3001/user/detail?uid=" + this.sessionUid
                )
                .then(
                  function(s) {
                    t.detail = s.data;
            ...
            getLikelist: function() {
              ...
              axios
                .get(
                  "http://46.101.60.239:3001/likelist?uid=" +
                    this.sessionUid +
                    "&cookie=" +
                    this.sessionCookie
                )
            ...
            getFirstSong: function() {
              var t = this;
              axios
                .get("http://46.101.60.239:3001/song/detail?ids=1808465866")
                .then(
                  function(s) {
            ...
            getSongList: function() {
              ...
              axios
                .get(
                  "http://46.101.60.239:3001/user/playlist?uid=" +
                    this.sessionUid +
                    "&cookie=" +
                    this.sessionCookie
                )
      ...
      var N = a("VU/8")(
        ...
        D = {
          ...
          methods: {
            getCode: function() {
              axios
                .get("http://46.101.60.239:3001/captcha/sent?phone=" + this.mobile)
                .then(
                  function(t) {
                    console.log(t);
                  },
            ...
            logInWithCode: function() {
              ...
              axios
                .get(
                  "http://46.101.60.239:3001/login/cellphone?phone=" +
                    this.mobile +
                    "&password=&captcha=" +
                    this.code
                )
        ...
        q = {
          ...
          methods: {
            getRecentSongs: function() {
              ...
              axios
                .post(
                  "http://46.101.60.239:3001/user/record?uid=" +
                    this.sessionUid +
                    "&type=1"
                )
                .then(
        ...
        W = {
          ...
          methods: {
            ...
            getHistoryList: function() {
              axios
                .get(
                  "http://46.101.60.239:3001/history/recommend/songs/detail?date=" +
                    this.year +
                    "-" +
                    this.month +
                    "-" +
        ...
        Z = {
          ...
          methods: {
            getListSongs: function() {
              ...
              axios
                .get(
                  "http://46.101.60.239:3001/playlist/detail?id=" + this.boardId
                )
                .then(
                  function(s) {
                    console.log(s),
        ...
        st = {
          ...
          methods: {
            searchSong: function() {
              ...
              axios
                .get(
                  "http://46.101.60.239:3001/cloudsearch?limit=50&keywords=" +
                    this.keyword
                )
                .then(
                  function(s) {
            ...
            searchAlbum: function() {
              ...
              axios
                .get(
                  "http://46.101.60.239:3001/cloudsearch?limit=50&type=10&keywords=" +
                    this.keyword
                )
                .then(
                  function(s) {
            ...
            searchSinger: function() {
              ...
              axios
                .get(
                  "http://46.101.60.239:3001/cloudsearch?limit=50&type=100&keywords=" +
                    this.keyword
                )
                .then(
                  function(s) {
            ...
            searchList: function() {
              ...
              axios
                .get(
                  "http://46.101.60.239:3001/cloudsearch?limit=50&type=1000&keywords=" +
                    this.keyword
                )
                .then(
                  function(s) {
            ...
            searchUser: function() {
              ...
              axios
                .get(
                  "http://46.101.60.239:3001/cloudsearch?limit=50&type=1002&keywords=" +
                    this.keyword
                )
                .then(
                  function(s) {
      ...
      var it = a("VU/8")(
        ...
        et = {
          ...
          methods: {
            newAll: function() {
              var t = this;
              axios.get("http://46.101.60.239:3001/top/song?type=0").then(
                function(s) {
            ...
            newCn: function() {
              var t = this;
              axios.get("http://46.101.60.239:3001/top/song?type=7").then(
                function(s) {
            ...
            newEa: function() {
              var t = this;
              axios.get("http://46.101.60.239:3001/top/song?type=96").then(
                function(s) {
            ...
            newJp: function() {
              var t = this;
              axios.get("http://46.101.60.239:3001/top/song?type=8").then(
                function(s) {
            ...
            newKr: function() {
              var t = this;
              axios.get("http://46.101.60.239:3001/top/song?type=16").then(
                function(s) {
        ...
        lt = {
          ...
          methods: {
            ...
            getSongUrl: function() {
              ...
              axios
                .get(
                  "http://46.101.60.239:3001/song/url?id=" +
                    this.songId +
                    "&cookie=" +
                    this.sessionCookie
                )
            ...
            getSongDetail: function() {
              var t = this;
              axios
                .get("http://46.101.60.239:3001/song/detail?ids=" + this.songId)
                .then(
                  function(s) {
        ...
        dt = {
          ...
          methods: {
            getList: function() {
              var t = this;
              axios
                .get("http://46.101.60.239:3001/playlist/detail?id=" + this.listId)
                .then(
                  function(s) {
