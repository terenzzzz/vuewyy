...
export default {
  ...
  methods: {
    ...
    getUserDetail: function () {
      var that = this
      axios.get('https://www.terenzzzz.com:3002/user/detail?uid=' + this.sessionUid).then
      (function (response) {
    ...
    getLikelist: function () {
      var that = this
      axios.get('https://www.terenzzzz.com:3002/likelist?uid=' + this.sessionUid + '&cookie=' + this.sessionCookie).then
      (function (response) {
    ...
    getFirstSong: function () {
      var that = this
      axios.get('https://www.terenzzzz.com:3002/song/detail?ids=1808465866').then
      (function (response) {
    ...
    getSongList: function () {
      var that = this
      axios.get('https://www.terenzzzz.com:3002/user/playlist?uid=' + this.sessionUid + '&cookie=' + this.sessionCookie).then
      (function (response) {
