...
export default {
  ...
  methods: {
    searchSong: function () {
      var that = this
      axios.get('https://www.terenzzzz.com:3002/cloudsearch?limit=50&keywords=' + this.keyword).then
      (function (response) {
    ...
    searchAlbum: function () {
      var that = this
      axios.get('https://www.terenzzzz.com:3002/cloudsearch?limit=50&type=10&keywords=' + this.keyword).then
      (function (response) {
    ...
    searchSinger: function () {
      var that = this
      axios.get('https://www.terenzzzz.com:3002/cloudsearch?limit=50&type=100&keywords=' + this.keyword).then
      (function (response) {
    ...
    searchList: function () {
      var that = this
      axios.get('https://www.terenzzzz.com:3002/cloudsearch?limit=50&type=1000&keywords=' + this.keyword).then
      (function (response) {
        console.log(response)
    ...
    searchUser: function () {
      var that = this
      axios.get('https://www.terenzzzz.com:3002/cloudsearch?limit=50&type=1002&keywords=' + this.keyword).then
      (function (response) {
        console.log(response)
